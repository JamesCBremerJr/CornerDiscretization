...
c
        ...
        subroutine print_sing(msg,n,m,amatr)
        implicit double precision (a-h,o-z)
        double precision amatr(n,m)
...
c
        if (info .ne. 0) then
        call prinf("in print_sing, ddegsdd failed with info=*",info,1)
        return
        endif
c
...
c
c$$$c
c$$$c        call dgesdd('N',n,n,cmatr,n,sing,u,n,vt,n,w,lw,iwork,info)
c$$$c
c$$$        call dgesvd('N','N',n,n,cmatr,n,sing,u,n,vt,n,w,lw,info)
c$$$c
c$$$        if (info .ne. 0) then
c$$$        call prinf("after dgesdd, info = *",info,1)
c$$$        stop
c$$$        endif
c$$$c
c$$$        do 1300 i=1,n
c$$$        sing(i)=sqrt(sing(i))
c$$$ 1300 continue
c
...
c
 1100 continue
c
c$$$c       Perform the SVD using d2mcudv.
c$$$c
c$$$        ifuv=0
c$$$        eps=1.0d-14
