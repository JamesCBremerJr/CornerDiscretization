        ...
        double complex  zs(10 000),ima,h0,h1,h00,h11,h0s(20 000),
     1      h1s(20 000),h00s(20 000),h11s(20 000)
        dimension ts(10 000),xs(10 000),ys(10 000),rs(100),
     1      errors(20 000)
c 
...
C 
c 
c        construct the array of test points where
c        the Hankel functions will be tested
c 
        ifexpon=0
...
c 
        iii=iii+1
        zs(iii)=(xs(i)+ys(i)*ima)*rs(ii)
 1200 continue
 1400 continue
c 
        call prinf('iii=*',iii,1)
        call prin2('zs as created*',zs,iii*2)
        call prin2('and ts are*',ts,n)
  
  
cccc         stop
  
c 
c       evaluate the hankel functions at the nodes via both hank101
c       and hank103, and compare them things
c 
        err0max=0
        err1max=0
...
c 
 ...
 1700 continue
        ...
        do 1800 i=1,iii
c 
        call hank103(zs(i),h00,h11,ifexpon)
  
        if(ifexpon .eq. 0) h00=h00*exp(ima*zs(i))
        if(ifexpon .eq. 0) h11=h11*exp(ima*zs(i))
...
c 
 ...
 1900 continue
        ...
        call prin2('time for old hank101*',timeold,1)
  
  
        timenew=tt4-tt3
  
        call prin2('time for new hank101*',timenew,1)
        ...
        d=abs((h1s(i)-h11s(i))/h11s(i))
        if(d .gt. err1max) err1max=d
 2000 continue
  
        call prin2('err0max=*',err0max,1)
        call prin2('err1max=*',err1max,1)
  
  
        call prin2('and errors=*',errors,iii)
...
c 
        ...
        implicit double precision (a-h,o-z)
        save
        double complex  z,h0,h1,h0u,h0r,h1u,h1r,
     1      fj0,fj1,y0,y1,com,zu,zr,ima,ser2,ser3,z2,
     2      cclog,cd
        double precision rea(2)
...
c 
        ...
        implicit double precision (a-h,o-z)
        save
        double complex  z,com,ima,cd,h0,h1,ccex,zzz9
        dimension rea(2)
        double precision c0p1(34),c0p1b(36),buf01(2)
        equivalence (c0p1(34),buf01(1)),
     1      (c0p1b(1),buf01(2)),(rea(1),com)
        double precision c1p1(34),c1p1b(36),buf11(2)
        equivalence (c1p1(34),buf11(1)),
     1      (c1p1b(1),buf11(2))
        double precision c0p2(34),c0p2b(28),buf02(2)
        equivalence (c0p2(34),buf02(1)),
     1      (c0p2b(1),buf02(2))
        double precision c1p2(34),c1p2b(28),buf12(2)
...
c 
        ...
        double complex  z,zinv,pp,qq,ima,h0,h1,pp1,qq1,
...
c 
        ...
        double complex  z,fj0,fj1,y0,y1,h0,h1,z2,cd,ima,cdddlog
c 
...
c        i. e. for abs(z) < 1 in the upper half-plane,
c        and for abs(z) < 4 in the lower half-plane,
...
c 
        ...
        implicit double precision (a-h,o-z)
        save
        double complex  z,com,ima,cd,h0,h1,cccexp,cdd,zz18
        dimension rea(2)
        double precision c0p1(34),c0p1b(36),buf01(2)
        equivalence (c0p1(34),buf01(1)),
     1      (c0p1b(1),buf01(2)),(rea(1),com)
        ...
        equivalence (c1p1(34),buf11(1)),
     1      (c1p1b(1),buf11(2))
        double precision c0p2(34),c0p2b(20),buf02(2)
        equivalence (c0p2(34),buf02(1)),
     1      (c0p2b(1),buf02(2))
        double precision c1p2(34),c1p2b(28),buf12(2)
        equivalence (c1p2(34),buf12(1)),
